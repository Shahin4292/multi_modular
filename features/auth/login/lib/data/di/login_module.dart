...
import 'package:login/data/remote/login_remote_data_source_imp.dart';
import 'package:login/data/repository/login_repository_imp.dart';
...
abstract class LoginModule {
  ...
  LoginRemoteDataSource provideLoginRemoteDataSource(LoginService loginService, NetworkInfo networkInfo) {
    return LoginRemoteDataSourceImp(loginService, networkInfo);
  }
